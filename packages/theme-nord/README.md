...
Adds additional `fg-` and `bg-` variants to the mark component matching all custom accent colors

```html
<mark fg-="nord0">nord0</mark>
<mark bg-="nord1">nord1</mark>
<!-- ... -->
<mark bg-="nord14">nord14</mark>
<mark fg-="nord15">nord15</mark>
```
