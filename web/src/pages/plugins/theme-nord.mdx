...
<p>Roses are <mark fg-="nord11">nord11</mark>, violets are <mark bg-="nord15" fg-="background0">nord15</mark>, apples are <mark fg-="nord12">nord12</mark>, and so is <mark fg-="nord10">nord10</mark></p>
`}
/>
...
```html
<html data-webtui-theme="nord"></html>
```
