...
<p>Roses are <mark fg-="red">red</mark>, violets are <mark fg-="purple">purple</mark>, oranges are <mark bg-="orange" fg-="background0">orange</mark>, and so are <mark fg-="blue" bg-=="background2">blue</mark></p>
`}
/>
