...
**Note:** The progress bar component automatically rounds the `value/max` value to the nearest character width
...
<Example
    ...
    `}
    html={`<span>[<progress value="75" max="100" id="one">75%</progress>] 75%</span>
<span>(<progress value="50" max="100" id="two">50%</progress>) 50%</span>
<span>|<progress value="25" max="100" id="three">50%</progress>| 25%</span>`}
/>
...
<Example
    ...
    `}
    html={`<span>&lt;<progress value="25" max="100" id="one">25%</progress>&gt; 25%</span>
<span>|<progress value="50" max="100" id="two">50%</progress>| 50%</span>
<span>]<progress value="75" max="100" id="three">75%</progress>[ 75%</span>`}
/>
